...
def main():
    ...
    print("""
  #################################################
  # MM Repair Development Environment Setup #
  #################################################

  This script will create your MM Repair dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your MM Repair project folder:
    [Arma 3 installation directory]\\{} => MM Repair project folder
    P:\\{}                              => MM Repair project folder
